...
export function initBuerHome({getLanguage,openManual,getReport}) {
  ...
  function renderMessages(){
    ...
    for(const [i,message] of current.messages.entries()) {
      ...
      let avatar;
      if(message.role==='assistant'){avatar=document.createElement('img');avatar.src='assets/buer-ai-orb.webp';avatar.alt='不二 AI';avatar.className='buer-avatar';}
