...
const copy = {
  zh: {
    ...
    openMenu: "打开更多功能", closeMenu: "关闭菜单", drawerBack: "返回", drawerTitle: "我的宇宙", drawerIntroKicker: "真实自己，流动人生", drawerIntroTitle: "把人生说明书留在自己手中", drawerIntroText: "你的出生资料、图谱与历史记录默认保存在这台设备上。", drawerActions: "你的空间", drawerHistoryHint: "重新打开保存在本机的人生说明书", drawerSettingsHint: "管理隐私模式、本地历史与数据", language: "语言", drawerLanguageHint: "切换界面与解读语言", aboutUs: "关于我们", drawerAboutHint: "认识不二见己 与我们相信的生命观", contactUs: "联系我们", drawerContactHint: "网站、邮箱与社交媒体", drawerLinksTitle: "帮助与说明", drawerFooter: "认识自己，不是为了证明自己。",
  ...
  en: {
    ...
    openMenu: "Open more", closeMenu: "Close menu", drawerBack: "Back", drawerTitle: "My Universe", drawerIntroKicker: "True to yourself. Flow with life.", drawerIntroTitle: "Keep your Life Manual in your hands", drawerIntroText: "Your birth details, chart, and history stay on this device by default.", drawerActions: "Your space", drawerHistoryHint: "Reopen Life Manuals saved on this device", drawerSettingsHint: "Manage privacy mode, local history, and data", language: "Language", drawerLanguageHint: "Switch the interface and reading language", aboutUs: "About us", drawerAboutHint: "Meet Buer Jianji and the philosophy behind it", contactUs: "Contact", drawerContactHint: "Website, email, and social channels", drawerLinksTitle: "Help and information", drawerFooter: "Knowing yourself is not about proving yourself.",
...
function updateAccessibleResultSummary(data) {
  ...
  chartPreview.alt = language === "zh"
    ? `不二见己：${type}，${authority}，${profile} 人生角色`
    : `Buer Jianji: ${type}, ${authority}, Profile ${profile}`;
}
...
document.querySelector('#shareDailyTip').addEventListener('click', async event => {
  ...
  try {
    ...
    preview.alt = dailyShareText(`${tip} 右下角二维码可打开 不二见己首页。`, `${tip} The QR code opens Buer Jianji.`);
...
async function shareDailyImage(save) {
  ...
  try {
    ...
    if (nativeRuntime && nativePlugin) {
      ...
      await navigator.share({ files:[file], title:dailyShareText('不二见己今日提示', 'Buer Jianji daily thought') });
    } else {
      const link = document.createElement('a');
