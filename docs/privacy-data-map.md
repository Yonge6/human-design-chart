...
| Local history | User device | Yes | Optional, default off | Never unless separate cloud consent | Local-history switch explicitly enabled | Browser/Capacitor storage | Until clear/delete/uninstall | Clear local history; turning the switch off can keep existing records or delete them all | None |
