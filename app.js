...
function updateAccessibleResultSummary(data) {
  ...
  chartPreview.alt = language === "zh"
    ...
    : `Buer Within: ${type}, ${authority}, Profile ${profile}`;
}
