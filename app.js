...
const copy = {
  zh: {
    ...
    openMenu: "打开更多功能", closeMenu: "关闭菜单", drawerBack: "返回", drawerTitle: "我的宇宙", drawerIntroKicker: "真实自己，流动人生", drawerIntroTitle: "把成长的线索留在自己手中", drawerIntroText: "管理你的成长档案、经历与行动。资料保存在本机，由你决定哪些内容供 AI 参考。", drawerActions: "你的空间", drawerHistoryHint: "重新打开保存在本机的人生说明书", drawerSettingsHint: "管理隐私模式、本地历史与数据", language: "语言", drawerLanguageHint: "切换界面与解读语言", aboutUs: "关于我们", drawerAboutHint: "认识不二见己 与我们相信的生命观", contactUs: "联系我们", drawerContactHint: "网站、邮箱与社交媒体", drawerLinksTitle: "帮助与说明", drawerFooter: "认识自己，不是为了证明自己。",
