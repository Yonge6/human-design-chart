...
var _SwissEphemeris = class _SwissEphemeris {
  ...
  julianDayToDate(jd, calendarType = 1) {
    ...
    const totalMinutes = Math.round((hour - wholeHour) * 60);
    return new Date(Date.UTC(year, month - 1, day, wholeHour, totalMinutes));
  }
  /**
  ...
  findNextLunarEclipse(startJulianDay, flags = (void 0).MoshierEphemeris, eclipseType = 0, backward = false) {
    this._checkReady();
    const normalizedFlags = (void 0)(flags);
    const normalizedEclipseType = (void 0)(eclipseType);
    const m = this.module;
   ...
   */
  calculateHouses(julianDay, latitude, longitude, houseSystem = (void 0).Placidus) {
    this._checkReady();
    const m = this.module;
    ...
    return {
      cusps,
      ascendant: ascmc[(void 0).Ascendant],
      mc: ascmc[(void 0).MC],
      armc: ascmc[(void 0).ARMC],
      vertex: ascmc[(void 0).Vertex],
      equatorialAscendant: ascmc[(void 0).EquatorialAscendant],
      coAscendant1: ascmc[(void 0).CoAscendant1],
      coAscendant2: ascmc[(void 0).CoAscendant2],
      polarAscendant: ascmc[(void 0).PolarAscendant],
      houseSystem
    };
  }
  /**
