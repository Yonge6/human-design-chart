...
1. Convert the entered local wall time to UTC with the historical IANA timezone offset.
2. Use Swiss Ephemeris to calculate tropical geocentric longitudes for the Sun, Moon, true lunar node, Mercury, Venus, Mars, Jupiter, Saturn, Uranus, Neptune, and Pluto. Earth and the south node are the exact 180-degree oppositions of the Sun and true north node.
